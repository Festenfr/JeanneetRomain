import { Renderer, Camera, Transform, Plane } from 'ogl/src/index.mjs'
import Media from './media'
import NormalizeWheel from 'normalize-wheel'
import lerp from '~/assets/js/math/lerp'
export default class Gallery {
    constructor(container, isLoaderAnimation, config) {
        this.speed = 1.5
        this.scroll = {
            ease: 0.05,
            current: -100,
    ...
    createMedias() {
        ...
        this.medias = Array.from(this.mediasElements).map((element) => {
            let media = new Media({
                ...
                screen: this.screen,
                viewport: this.viewport,
                isLoaderAnimation: this.isLoaderAnimation,
                config: this.config
            })
            return media
        })
