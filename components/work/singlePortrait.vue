<template>
    <div class="single-portrait">
        <div ref="c_img_portrait" class="c_img_portrait">
...
export default {
    ...
    mounted() {
        this.resize()
        this.imageContainer = document.querySelectorAll('.c_img_portrait')
        this.imageContainer.forEach((element) => {
            let randLeft = randomInt(30, 65)
    ...
    methods: {
        ...
        resize(w, h) {
            this.imgProportion =
                this.$refs.c_img_portrait.clientWidth / window.innerWidth
